...
def test_paused_whale_copies_nothing(monkeypatch):
    ...
    +$275.50, +104.6% ROI settled; prop bleed blocked at type level) —
    the mechanism is exercised with a synthetic entry, and his
    strongest cell is asserted COPYABLE again."""
    from edge.shadow import copy_sports as cs
