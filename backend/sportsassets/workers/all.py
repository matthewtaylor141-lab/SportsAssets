...
LOOPS: list[tuple[str, Callable[[], Awaitable[None]]]] = [
    ...
    #
    # DEREGISTERED 2026-09-22. This is the rollback for the Stage 2
    # activation at 88d429ed, and it is deliberately the bluntest
    # one available: the supervisor cannot start what it is not
    # handed.
    #
