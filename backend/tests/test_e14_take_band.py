...
def test_e14_the_census_name_sits_before_drift_smaller_open_and_the_pins_hold():
    ...
    assert keys[keys.index("take_in_band") + 35] == "drift_smaller_open"
    ...
    assert keys[-48] == "take_in_band" and keys[-13] == "drift_smaller_open" and keys[-12] == "registered_no_increase"
