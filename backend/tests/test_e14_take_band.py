...
def test_e14_the_census_name_sits_before_drift_smaller_open_and_the_pins_hold():
    ...
    assert keys[keys.index("take_in_band") + 14] == "drift_smaller_open"
    ...
    # FILL lane 3 (three names), T2 (two), FILL lane 5 (three), E22 (FILL lane 22, four) and FILL lane 11 (one) placed theirs after this one (-14 -> -27)
