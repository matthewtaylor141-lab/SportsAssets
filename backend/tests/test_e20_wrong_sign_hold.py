...
def test_e20_census_place_may_hold_list_and_the_source_shape():
    keys = ml.CENSUS_KEYS
    # E14b, E14, FILL lane 3 (three), T2 (two), FILL lane 5 (three) and E22 (FILL lane 22, four) landed after E20 and sit nearer the key (-16/-15/-14 -> -28/-27/-26)
    assert keys[-28] == "wrong_sign_hold" and keys[-27] == "exit_take_rested" and keys[-13] == "drift_smaller_open"
    assert keys[-26] == "take_in_band"
