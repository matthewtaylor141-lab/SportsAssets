...
def test_c9_no_census_name_the_three_heartbeat_keys_the_plan_field_and_no_order_path_reads_the_columns():
    ...
    assert tuple(keys[-35:-31]) == ("lost_fill_adopted", "lost_fill_unread", "lost_fill_unexplained", "lost_fill_ambiguous")
    assert tuple(keys[-38:-35]) == ("he_holds", "he_holds_unread", "reopen_refused")
