...
def test_rolling_loss_breaker_pauses_copies(monkeypatch):
    ...
    scaled to $2250 with the +50% clip order 2026-08-17, to $3500
    with the max-profitability clip pass 2026-08-20, and to $5000 with
    the 2026-08-21 dossier promotions — the breaker keeps pace with
    deployed dollars so ordinary variance never halts the sleeve):
