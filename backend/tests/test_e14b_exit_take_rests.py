...
def test_e14b_the_census_name_sits_before_drift_smaller_open_and_the_tail_pins_hold():
    ...
    # FILL lane 3 (three names), T2 (two), FILL lane 5 (three), E22 (FILL lane 22, four) and FILL lane 11 (one) placed theirs after these (-15 -> -28, -14 -> -27)
    assert keys[-28] == "exit_take_rested" and keys[-27] == "take_in_band"
