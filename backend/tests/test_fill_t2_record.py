...
def test_t2_the_census_names_sit_before_drift_smaller_open_the_emit_sites_and_no_order_path_reads_the_table():
    ...
    # FILL lane 5 (three names), E22 (FILL lane 22, four) and FILL lane 11 (one) landed after this lane and placed theirs nearer the key (-15/-14 -> -23/-22)
    assert keys[-23] == "fill_answer_write_failed" and keys[-22] == "fill_answers_absent"
    # FILL lane 3 landed first and sits between E14's name and these two (take_in_band -16 -> -27)
    assert keys[-27] == "take_in_band" and keys[-26] == "exit_take_in_band" and keys[-24] == "order_open_his_exit"
