...
def test_e17_the_census_names_sit_before_registered_no_increase():
    ...
    # and E22 (FILL lane 22) its four lost_fill_* names (-> -36:-28), FILL lane 11 its one `cand_market_closed_db` (-> -37:-29) and FILL lane 16 its one `turn_woke_fast` (-> -38:-30)
    assert keys[-38:-30] == ("standing_row_reanchored", "standing_row_ambiguous", "standing_row_reanchor_failed",
