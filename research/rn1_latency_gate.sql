...
WITH code(tbl, field, used_as, stage2, stage4) AS (
  VALUES
  ('trades', 'ts', 'C1 source fill clock -- MIXED DOMAIN', 'WRITE_SITE', 'VERIFIED_BUT_MIXED_DOMAIN'),
  ('trades', 'detected_at', 'C2 detection clock', 'WRITE_SITE', 'VERIFIED'),
  ('trades', 'venue_seen_at', 'claimed venue-feed clock', 'WRITE_SITE', 'UNVERIFIED'),
  ('copy_probes', 'probe_at', 'C2 observation-START clock', 'WRITE_SITE', 'VERIFIED_AS_A_LOWER_BOUND'),
  ('copy_probes', 'fill_ts', 'C1 source clock, carried', 'WRITE_SITE', 'VERIFIED'),
  ('copy_probes', 'reaction_s', 'the cross-domain difference', 'WRITE_SITE', 'VERIFIED_AS_A_CROSS_DOMAIN_DIFFERENCE'),
  ('copy_probes', 'best_ask', 'best_ask_at_action', 'WRITE_SITE', 'VERIFIED'),
  ('copy_probes', 'depth', 'the depth walk -- top 8 levels', 'WRITE_SITE', 'VERIFIED_BUT_TRUNCATED'),
  ('copy_probes', 'book_ok', 'was a book observed at all', 'WRITE_SITE', 'VERIFIED'),
  ('price_path', 't_s', 'the delay bucket', 'WRITE_SITE', 'VERIFIED'),
  ('price_path', 'ask', 'PMUS ask at the offset', 'WRITE_SITE', 'VERIFIED'),
  ('price_path', 'sampled_at', 'C3 sample clock', 'DB_DEFAULT', 'VERIFIED'),
  ('mirror_orders', 'placed_at', 'C3 PRE-SEND clock', 'WRITE_SITE', 'VERIFIED_AS_PRE_SEND'),
  ('mirror_orders', 'updated_at', 'mutable; nearest ack proxy', 'WRITE_SITE', 'UNVERIFIED_BECAUSE_MUTABLE'),
  ('mirror_orders', 'done_at', 'C3 terminal clock', 'WRITE_SITE', 'VERIFIED'),
  ('mirror_orders', 'receipt', 'possible C4 venue timestamp', 'WRITE_SITE', 'UNVERIFIED'),
  ('mirror_orders', 'ask_at_send', 'the ask re-read immediately before a send', 'WRITE_SITE', 'VERIFIED'),
  ('service_heartbeats', 'beat_at', 'C3 half of a possible clock bridge', 'WRITE_SITE', 'VERIFIED')
), rn1 AS MATERIALIZED (
