-- BRIDGE PRE-FLIGHT: PLAN ONLY. GENERATED from research/rn1_bridge.sql.

\echo '== PLAN ONLY -- 1. BUY COVERAGE: how much of the BUY cohort has its OWN usable ladder =='
...
\echo '== PLAN ONLY -- 2. BUY EXECUTION on the fully measurable subset: drag, fill, fee vs pair edge =='
...
\echo '== PLAN ONLY -- 3. SELECTION TEST: is the measurable BUY subset like the rest of the cohort? =='
...
\echo '== PLAN ONLY -- 4. BUY price-band and sport detail, measurable vs not =='
...
\echo '== PLAN ONLY -- 5. SELL side: PARTIALLY IDENTIFIED against a contemporaneous neutral bid =='
