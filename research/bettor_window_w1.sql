...
--   + 10 min warm-up    -> 2026-09-20T21:28:19Z   WINDOW START
--   + 30 min declared   -> 2026-09-20T21:58:19Z   WINDOW END
--
...
SELECT 'A_WINDOW' AS section, k, v FROM (
    SELECT 'WINDOW_START' AS k, '2026-09-20T21:28:19Z' AS v
    UNION ALL SELECT 'WINDOW_END', '2026-09-20T21:58:19Z'
    UNION ALL SELECT 'NOW', now()::text
    UNION ALL
    SELECT 'COHORT_OBSERVATIONS', count(*)::text
      FROM bettor_state_observations
     WHERE observed_at >= '2026-09-20T21:28:19Z'::timestamptz
       AND observed_at <  '2026-09-20T21:58:19Z'::timestamptz
    UNION ALL
...
SELECT 'C_TICK_LEDGER', k, v FROM (
    ...
    UNION ALL SELECT 'OBS_SCHEDULED', coalesce(sum(obs_scheduled),0)::text
      FROM bettor_capture_ticks WHERE tick_at >= '2026-09-20T21:28:19Z'::timestamptz AND tick_at < '2026-09-20T21:58:19Z'::timestamptz
