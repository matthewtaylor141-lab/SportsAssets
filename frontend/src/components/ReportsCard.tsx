...
//
// OFF the public Performance page since 2026-08-22 (owner order: public
// numbers are copy-whales only — this card's blended headline mixes in
// software/manual). Desk/ops surfaces may still mount it.
